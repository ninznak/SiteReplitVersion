...
const articles = [
{
  ...
  date: 'March 14, 2026',
  readTime: '8 min read',
  img: "https://img.rocket.new/generatedImages/rocket_gen_img_1bceaf767-1772139672744.png",
...
},
{
  ...
  date: 'March 8, 2026',
  readTime: '6 min read',
  img: "https://img.rocket.new/generatedImages/rocket_gen_img_1114f5871-1773829115154.png",
...
},
{
  ...
  date: 'Feb 28, 2026',
  readTime: '5 min read',
  img: "https://images.unsplash.com/photo-1658093656611-0c6efe7f5ffd",
...
},
{
  ...
  date: 'Feb 20, 2026',
  readTime: '7 min read',
  img: "https://img.rocket.new/generatedImages/rocket_gen_img_185c526bb-1772183031822.png",
  alt: 'AI video generation interface showing 3D model animation frames',
  featured: false
}];
          ...
          <div className="lg:col-span-7 reveal-left group cursor-pointer">
            <div className="relative overflow-hidden rounded-3xl bg-bg-card border border-primary/10 shadow-green-sm h-full">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8">
                ...
                <p className="text-sm text-white/70 leading-relaxed mb-5 max-w-lg">{featured?.excerpt}</p>
                <div className="flex items-center justify-between">
                  <span className="text-[11px] text-white/40 uppercase tracking-widest">{featured?.date}</span>
