...
const featured = [
{
  ...
  year: '2026',
  img: "https://images.unsplash.com/photo-1634721648359-679131f453f0",
...
},
{
  ...
  year: '2026',
  img: "https://img.rocket.new/generatedImages/rocket_gen_img_1e9abf01c-1773829118252.png",
...
},
{
  ...
  medium: '3D Coins',
  year: '2025',
  img: "https://images.unsplash.com/photo-1643393670617-0915d3f6d1b8",
...
},
{
  ...
  medium: 'AI Image',
  year: '2025',
  img: "https://img.rocket.new/generatedImages/rocket_gen_img_113c53f41-1769368443405.png",
...
export default function FeaturedWorks() {
  ...
  return (
    <section ref={sectionRef} className="py-28 bg-bg-dark relative overflow-hidden z-10">
      {/* Dark section orb glow */}
      <div
        className="absolute inset-0 pointer-events-none"
        style={{ background: 'radial-gradient(ellipse 70% 50% at 30% 50%, rgba(61,122,79,0.15) 0%, transparent 70%)' }}
        aria-hidden="true" />
              ...
              style={{ marginTop: idx === 1 ? '40px' : '0' }}>
                ...
                <div className="absolute bottom-0 left-0 right-0 p-7">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-[10px] uppercase tracking-widest font-medium text-accent">{item?.medium}</span>
