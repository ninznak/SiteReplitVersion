    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-bg-dark flex-col justify-between p-12">
        ...
        <div
          ...
          style={{
            background:
              'linear-gradient(135deg, #0D1F12 0%, #162B1C 40%, #1E3D28 70%, #0D1F12 100%)',
          }}
          aria-hidden="true"
        />
        ...
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse 70% 60% at 40% 50%, rgba(168,201,87,0.12) 0%, transparent 70%)',
          }}
          aria-hidden="true"
        />
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center px-6 py-16 min-h-screen relative">
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mt-8 text-center">
            <Link
              href="/homepage"
              className="text-sm text-foreground-subtle hover:text-primary transition-colors inline-flex items-center gap-1.5"
            >
              <svg
                width="14"
                height="14"
