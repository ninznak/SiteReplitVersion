  ...
  return (
    <section ref={sectionRef} id="ai" className="py-20 bg-bg-dark relative overflow-hidden z-10">
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 60% 60% at 60% 40%, rgba(168,201,87,0.08) 0%, transparent 70%)',
        }}
        aria-hidden="true"
      />
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-start mb-14 reveal">
          <div className="lg:col-span-7">
            <span className="text-[10px] font-semibold uppercase tracking-[0.3em] text-accent block">
              {t('portfolio.ai.label')}
            </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-5">
          {filtered.map((work, idx) => {
            ...
            return (
              ...
              >
                <div
                  className={`overflow-hidden ${work.size === 'large' ? 'aspect-[4/3]' : work.size === 'medium' ? 'aspect-square' : 'aspect-[3/4]'}`}
                >
                  <AppImage src={work.img} alt={work.alt} fill className="object-cover" />
