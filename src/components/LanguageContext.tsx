...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'carousel.commission.tag': 'Latest Commission',
    'carousel.commission.title': 'Silver Relief Panel',
    'carousel.commission.subtitle': 'Custom Order · In Progress',
    'carousel.3d.tag': '3D Models',
    'carousel.3d.title': 'Bas Relief Collection',
    'carousel.3d.subtitle': '200+ Models Available',
  },
  ru: {
    ...
    'carousel.commission.tag': 'Последний Заказ',
    'carousel.commission.title': 'Серебряная Рельефная Панель',
    'carousel.commission.subtitle': 'Под Заказ · В Работе',
    'carousel.3d.tag': '3D Модели',
    'carousel.3d.title': 'Коллекция Барельефов',
    'carousel.3d.subtitle': '200+ Моделей Доступно',
  },
};
